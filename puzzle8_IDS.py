...
def ids(initial_state):
    ...
    while True:
        ...
        explored = set()  # Reset explored for each depth limit
        parent_map = {initial_state: None}  # Reset parent_map for each depth limit

        # Perform depth-limited search within the current depth limit
        while frontier:
